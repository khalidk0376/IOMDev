...
@description : This is simple drawer table that get amendment opp and apply all other feature like pagination, sorting, filter and search.
...
export default class AmendmentRequests extends LightningElement {
    //action properties
    ...
    @api fields='Id,Account.Name,Name,Default_Edition__r.Name,CloseDate,StageName,Status__c,Owner.Name';
   ...
   setFilterOptions(filterNum,fieldName){
    ...
    @track isOpenAmendModal;
    completeAmend(event){
        this.selectedRecordId = event.target.value;
        this.isOpenAmendModal = true;
    }
    closeAmendModal(){
        this.selectedRecordId=undefined;
        this.isOpenAmendModal = false;
    }
    yesCompleteAmend(){
        this.spinner = true;
        let objList = [{Complete_Amend__c:true,Status__c:"Awaiting Payment",sobjectType:'Opportunity',Id:this.selectedRecordId}]
