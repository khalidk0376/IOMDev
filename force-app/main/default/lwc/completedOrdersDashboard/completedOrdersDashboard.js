...
export default class CompletedOrdersDashboard extends LightningElement {

    @track openActionModal=false;
    @track readonly = true;
    @track recordId='';
    @track error;
    @track completedOrderCond;
    @track ordFields = '';
    ...
    */
    getSSCTeamMember(){
        ...
        .then(data=>{
            ...
            this.completedOrderCond = "(Order_Translation_Status__c=\'Completed\' AND Edition__r.Part_of_Series__c IN ('"+ids.join("','")+"'))";
        })
        .catch(error=>{
