...
export default class OrderErrorDashboard extends LightningElement {
    ...
    getSSCTeamMember()
      .then(result => {
        if (result) {
          ...
          this.condition = '(Tax_Status__c=\'Error\' AND SBQQ__Quote__r.Edition__r.Part_of_Series__c IN (\'' + ids.join('\',\'') + '\'))';
          this.showTable = true;
