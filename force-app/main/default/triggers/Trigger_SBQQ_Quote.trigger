/**
* File:         Trigger_SBQQ_Quote
* Project:      PoC SFDC Informa
* Test Class:   cancelAndRebilPostedInvoicesFCR_Test
* Coverage:     96%
* *******************************************************************************************************
* @description : Trigger on SBQQ_Quote that will run on after update.
...
trigger Trigger_SBQQ_Quote on SBQQ__Quote__c (before insert, before update, before delete, after insert, after update, after delete, after undelete) {
    ...
    /**
    * Description: Calling TriggerInterface_SBQQ_Quote class for SBQQ_Quote object.
    */
